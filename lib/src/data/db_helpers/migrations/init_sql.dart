...
class InitDbFile {
  ...
  Future<File> get _localFile async {
    ...
    return File('$path/init.sql');
  }

  Future<File> writeInitDb() async {
    final file = await _localFile;

    // Write the file
    return file.writeAsString(sql);
  }
}
...
--- TABLE conhecimentos_necessarios
...
('e073818f-513c-40fa-9e98-b0cda05bf561', 'discente'),
('d085d435-41ec-49d2-866c-6d4ccfe9e5cf', 'docente');

-- INSERT INTO auth
INSERT INTO auth(
  id, id_usuario, email, passwd, isautenticated, id_role
) VALUES
('a8e16013-36c3-42d4-81d0-28d74adfe3d2','c0cab1eb-9128-4b91-8639-56fdc179a1ec','tarsismarinho@ifal.edu.br', 'cadeaissue', true, 'd085d435-41ec-49d2-866c-6d4ccfe9e5cf'),
('62ac3125-aa36-4f00-8cc5-54e45872da3b','6d6083a7-8e2c-4416-bf09-77f309210517','lfb3@aluno.ifal.edu.br', 'funcionariodomes', true, 'e073818f-513c-40fa-9e98-b0cda05bf561'),
('36fe83e2-f509-4045-8f5c-6a6e8f6c388c', 'a55a9819-6601-49e6-8b32-f0bc9d9f83a6', 'danielfireman@ifal.edu.br','carecaporamor',true,'d085d435-41ec-49d2-866c-6d4ccfe9e5cf');

-- INSERT INTO usuario
INSERT INTO usuario(
  id, url_image, name, descricao
) VALUES
...
-- INSERT INTO usuario
INSERT INTO usuario(
  id, url_image, name, turma, descricao
) VALUES
...
-- INSERT INTO vaga
INSERT INTO vaga(
  id, name, quant_horas, vagas_disp, proposta, o_que_irei_fazer, avaliacao_user, bolsa_disp
) VALUES
(1, 'Vaga Backend DIT', 42, 4, 'vaga pra backend dit', 'ira programar', 4.6, 600.0);

-- INSERT INTO inscreve_em
INSERT INTO inscreve_em(
  id, id_vaga, id_colaborador, status, created_at, updated_at, cargo
) VALUES
